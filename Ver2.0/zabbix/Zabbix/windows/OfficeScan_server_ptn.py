...
def get_officescan_server_ptn():
	os.system(r"C:\Zabbix\windows\PSTools\psexec -u administrator -p password C:\Zabbix\windows\OfficeScan_server_ptn_copy.bat")
	
	config=configparser.ConfigParser(strict=False,allow_no_value=True)
	config.read(r'C:\Zabbix\windows\ofcscan.ini')
